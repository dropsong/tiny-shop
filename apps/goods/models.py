...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self", null=True, blank=True, verbose_name="父类目级别", help_text="父目录",related_name="sub_cat",on_delete=models.CASCADE)  # 自关联
...
class GoodsCategoryBrand(models.Model):
    ...
    品牌名
    """
    # 可以用 GoodsCategory.brands.all() 来查看某个 GoodsCategory 下的所有品牌
...
class Goods(models.Model):
    ...
    is_new = models.BooleanField(default=False, verbose_name="是否新品") # 新品会呈现在主页中间
    is_hot = models.BooleanField(default=False, verbose_name="是否热销") # 热销品会呈现右侧
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
# 一个商品可以有多个详情图片，上面的 goods_front_image 只是一个封面图
