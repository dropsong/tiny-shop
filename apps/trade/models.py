...
class OrderInfo(models.Model):
    ...
    order_sn = models.CharField(max_length=30, null=True, blank=True, unique=True, verbose_name="订单号")   # 例如：我们网站自己的订单号
    trade_no = models.CharField(max_length=100, unique=True, null=True, blank=True, verbose_name=u"交易号")  # 例如：支付宝的交易号
